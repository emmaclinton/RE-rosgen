...
CrossProf <- read.csv("../../data/derived/public/cross_prof.txt", header=FALSE, sep = " ", col.names=c("Junk","Distance","Elevation"))[c(2,3)]
LongProf <- read.csv("../../data/derived/public/long_prof.txt", header=FALSE, sep = " ", col.names=c("Junk","Distance","Elevation"))[c(2,3)]
```
...
ggplot(LongProf) +
       ...
       scale_color_gradient(low = "gray", high = "red") +
       theme_light() +
       labs(x = "Distance along the transect (m)", y = "Elevation (masl)", title = "Longitudinal Profile with Slope of Extracted Reach")
```
...
DpthBf_Max <- 1.0406 # Insert the maximum bankfull depth from your point/reach of interest here, replacing the 8 left of the hash #
...
ggplot(CrossProf) +
       ...
       xlim(220,300) + # Sets the x-axis limits. Adjust this value as you zoom in to the correct area.
